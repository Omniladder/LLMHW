...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        causal_mask = torch.ones(config.block_size, config.block_size)
    ...
    def forward(self, x):
        ...
        att = torch.matmul(q, k.transpose(-1,-2)) / (self.n_embd // self.n_head)**0.5
        ...
        #self.causal_mask = self.causal_mask.expand_as(att[:, :, :T, :T])
